<template>
    ...
    <el-main v-else>
        ...
        <el-dialog
                    ...
                    <ul class="dialogmain">
                        <div class="alltop" :class="{alselect:selectlist.length==brand_list.length}"  @click="selectedall">
                            全部品牌
                            <i v-if="selectlist.length==brand_list.length">
                                <img src="../../images/setImg/lifttop.png" alt="">
                            </i>
                        </div>
