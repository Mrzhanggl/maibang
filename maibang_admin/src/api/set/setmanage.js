...
export function judgeUserPermission(){
    return request({
        url: "/discount/judgeUserPermission",
        method: "get",                   
    })
}
//获取智能查询开关状态
export function intelligenceSearchType(){
    return request({
        url: "/pc_seller/store/intelligenceSearchType",
        method: "post",                
    })
}
//设置开关状态
export function saveIntelligenceSearchType(data){
    return request({
        url: "/pc_seller/store/saveIntelligenceSearchType",
        method: "post",   
        data:{
            ...data
        }             
...
export function majorBrand(){
    return request({
        url: "/pc_seller/store/majorBrand",
        method: "post",                
    })
}
//保存主营品牌
export function saveMajorBrand(data){
    return request({
        url: "/pc_seller/store/saveMajorBrand",
        method: "post",   
        data:{
            ...data
        }             
