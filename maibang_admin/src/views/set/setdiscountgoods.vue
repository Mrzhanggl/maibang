...
export default {
    ...
    methods:{        
        ...
        gourl(){           
            ...
            localStorage.setItem('disId',this.disId);                            
        ...
        getData(){                        
            ...
            getSkuDiscount(getSku).then(res=>{
                ...
                // }
                // else{
                    if(localStorage.getItem('radio2')||localStorage.getItem('price')||localStorage.getItem('percentage')||localStorage.getItem('startTime')||localStorage.getItem('endTime')||localStorage.getItem('disId')){                                                                                   
                    //    alert(localStorage.getItem('radio2'));
                       this.form.startTime = localStorage.getItem('startTime');
                        this.form.endTime = localStorage.getItem('endTime');
                        this.form.price = localStorage.getItem('price');
                        ...
                        this.disId = localStorage.getItem('disId');                         
                    }
                    else{                        
